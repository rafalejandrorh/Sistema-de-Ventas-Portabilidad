<?php
	...
	function generateRow($from, $to, $conn, $deduction){
		...
		while($row = $query->fetch_assoc()){
			...
			$rate_dolar2 = $rate_dolar['rate_dolar'];
			...
			$percentdeduction = $deduction * $gross / 100;
			$total_deduction = $percentdeduction + $cashadvance;
    ...
    $content .= '
      	...
      	<table border="1" cellspacing="0" cellpadding="3">  
           <tr>  
           		<th width="25%" align="center"><b>Nombre Empleado</b></th>
                <th width="25%" align="center"><b>Cédula de Identidad</b></th>
				<th width="25%" align="center"><b>Salario Neto en Dólares</b></th>
				<th width="25%" align="center"><b>Salario Neto en Bolivares</b></th>  
           </tr>  
      ';  
