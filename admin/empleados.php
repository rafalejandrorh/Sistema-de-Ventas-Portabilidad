...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, empleados.id AS empid FROM empleados LEFT JOIN cargos ON cargos.id=empleados.position_id LEFT JOIN horarios ON horarios.id=empleados.schedule_id";
  ...
  <?php include 'includes/empleados_modal.php'; ?>
</div>
