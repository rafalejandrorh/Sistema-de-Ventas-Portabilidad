        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
					...
					<div class="col-sm-9">
					<div class="bootstrap-timepicker">
							<select class="form-control" name="MES" id="delete_MES" required>
                        <option id="delete_MES"  selected></option>
                        <option value="January" >Enero</option>
                        <option value="February">Febrero</option>
                        <option value="March">Marzo</option>
                        <option value="April">Abril</option>
                  	...
                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
						<input type="text" name="META" id="delete_META">
                    	</div>
                  	</div>
				</div>
				</div>
...
<!-- Editar tasa del dólar BCV con API de DolarToday-->
<div class="modal fade" id="dolar">
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
