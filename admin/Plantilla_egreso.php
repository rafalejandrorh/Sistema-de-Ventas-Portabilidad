...
<div class="content-wrapper">
    ...
    <section class="content-header">
            ...
            <h1>Plantilla</h1>
            <ol class="breadcrumb">
            <li><a href="#"><i class="ion ion-alert-circled"></i>Plantilla</a></li>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h1 class="card-title"><b>Egresos</b></h1>
              </div>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                        <?php
                        $sql="SELECT *, plantilla.CEDULA AS cedid from plantilla LEFT JOIN estatus ON plantilla.ESTATUS=estatus.ID WHERE estatus.ID= 2";
