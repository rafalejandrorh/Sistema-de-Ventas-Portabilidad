...
<div class="wrapper">
          ...
          <div class="box">
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM ventas_config";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          <td class='hidden'></td>
                          <td class='col-xs-1'>".$row['MES_VENTAS']."</td>
                          <td>
                            <button class='btn btn-success btn-sm btn-flat edit' data-id='".$row['MES_VENTAS']."'><i class='fa fa-edit'></i> Editar</button>
                          </td>
                        </tr>
                      ";
                    }
  ...
  <?php include 'includes/configventas_modal.php'; ?>
</div>
