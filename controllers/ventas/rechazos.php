              ...
              <div class="box-body">
                ...
                <thead>
                  ...
                  <tbody>
                        ...
                        $sql="SELECT * from ventastotales WHERE ESTATUS = 'PIN INCORRECTO' AND FECHA_CARGA BETWEEN '$from' AND '$to'";
                        ...
                        $sql="SELECT * from ventastotales WHERE ESTATUS = 'PIN EXPIRADO' AND FECHA_CARGA BETWEEN '$from' AND '$to'";
                        $query = $conn->query($sql);
                            while($row = $query->fetch_assoc()){
                              ?>
                              <tr>
                        ...
                        $sql="SELECT * from ventastotales WHERE ESTATUS = 'PIN INEXISTENTE' AND FECHA_CARGA BETWEEN '$from' AND '$to'";
                        $query = $conn->query($sql);
                            while($row = $query->fetch_assoc()){
                              ?>
                              <tr>
                        ...
                        $sql="SELECT * from ventastotales WHERE ESTATUS = 'CURP INVALIDA' AND FECHA_CARGA BETWEEN '$from' AND '$to'";
                        $query = $conn->query($sql);
                            while($row = $query->fetch_assoc()){
                              ?>
                              <tr>
...
$("#reservation").on('change', function(){
    ...
    window.location = 'rechazos.php?range='+range;
  });
