  	...
  	<div class="login-box-body">
    	...
    	<form action="login.php" method="POST">
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control" name="username" placeholder="Ingresa Usuario de Ejecutivo" required autofocus>
            ...
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      		...
      		<div class="row">
    			<div class="col-xs-5">
				  ...
				  <div class="col-xs-7">
                <a href="../admin/index.php"><button type="button" class="btn btn-primary btn-block btn-flat" name="login"><i class="fa fa-suitcase"></i> Administrador</button></a>
        		</div>
      		</div>
    	</form>
  	</div>
